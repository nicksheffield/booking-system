...
angular.module('app.controllers').controller('classViewCtrl', ["$scope", "$stateParams", "$store", "$location", "$invalidate", "$prepare", "Group", "User", "sweetAlert", function ($scope, $stateParams, $store, $location, $invalidate, $prepare, Group, User, sweetAlert) {
	...
	$scope.retire = function () {
		...
		Group.update({ id: $scope.group.id }, $scope.group).$promise.then($prepare.group).then(function (res) {
