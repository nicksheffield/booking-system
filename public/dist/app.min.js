...
angular.module('app.controllers').controller('unitImportCtrl', ["$scope", "$q", "$invalidate", "$store", "$location", "$csv", "$xlsx", "Unit", function ($scope, $q, $invalidate, $store, $location, $csv, $xlsx, Unit) {
	window.$scope = $scope;
