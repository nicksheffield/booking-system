...
angular.module('app.controllers').controller('kitEditCtrl', ["$scope", "$store", "$location", "$invalidate", "Kit", function ($scope, $store, $location, $invalidate, Kit) {
