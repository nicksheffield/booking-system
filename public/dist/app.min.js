...
angular.module('app.controllers').controller('userImportCtrl', ["$scope", "$q", "$invalidate", "$store", "$location", "$csv", "$xlsx", "User", function ($scope, $q, $invalidate, $store, $location, $csv, $xlsx, User) {
