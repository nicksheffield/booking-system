...
angular.module('app.controllers').controller('bookingsManageCtrl', ["$scope", "$store", "$load", "$stateParams", "Booking", function ($scope, $store, $load, $stateParams, Booking) {
	window.$scope = $scope;
