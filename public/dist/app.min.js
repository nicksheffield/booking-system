...
angular.module('app.services').factory('$invalidate', ["$rootScope", "$auth", "$store", "$interval", "$load", function ($rootScope, $auth, $store, $interval, $load) {
	...
	service.all = function () {
		if ($auth.getPayload() && $auth.getPayload().admin) {
			...
			service.add(['user', 'users', 'groups', 'group_types', 'product_types', 'products', 'units', 'notes']);
		} else {
...
angular.module('app.services').factory('$load', ["$store", "$prepare", "$auth", "User", "Group", "Group_Type", "Product_Type", "Product", "Unit", "Booking", "Note", function ($store, $prepare, $auth, User, Group, Group_Type, Product_Type, Product, Unit, Booking, Note) {
	var service = {};
	var events = [];
