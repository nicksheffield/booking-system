...
angular.module('app', ['ngResource', 'ngSanitize', 'satellizer', 'ui.router', '19degrees.ngSweetAlert2', 'app.controllers', 'app.directives', 'app.resources', 'app.services', 'app.filters', 'app.routes', 'app.views', 'app.auth']);
'use strict';
...
angular.module('app.controllers').controller('issueCtrl', ["$scope", "$stateParams", "$store", "$location", "$http", "$invalidate", "$load", "$prepare", function ($scope, $stateParams, $store, $location, $http, $invalidate, $load, $prepare) {
	...
	$scope.issue = function () {
		...
		var allChosen = $scope.units.reduce(function (prev, cur) {
			return prev && !!cur;
		}, true);
...
angular.module("app.views").run(["$templateCache", function ($templateCache) {
  ...
  $templateCache.put("components/manage/class_types/views/edit.html", "<page-header text=\"{{ type.name }}\"><btn type=\"primary\" icon=\"floppy-o\" ng-click=\"save()\">Save</btn></page-header><div class=\"page-content\"><form ng-submit=\"save()\"><div class=\"fake-table data-table\"><div class=\"tr\"><div class=\"td row-property center\">Code</div><div class=\"td row-value\"><input type=\"text\" id=\"name\" ng-model=\"type.code\" class=\"form-control\"></div></div><div class=\"tr\"><div class=\"td row-property center\">Name</div><div class=\"td row-value\"><input type=\"text\" id=\"name\" ng-model=\"type.name\" class=\"form-control\"></div></div></div></form></div>");
  ...
  $templateCache.put("components/manage/class_types/views/new.html", "<page-header text=\"New Class Type\"><btn type=\"primary\" icon=\"floppy-o\" ng-click=\"save()\">Save</btn></page-header><div class=\"page-content\"><form ng-submit=\"save()\"><div class=\"fake-table data-table\"><div class=\"tr\"><div class=\"td row-property center\">Code</div><div class=\"td row-value\"><input type=\"text\" id=\"name\" ng-model=\"code\" class=\"form-control\"></div></div><div class=\"tr\"><div class=\"td row-property center\">Name</div><div class=\"td row-value\"><input type=\"text\" id=\"name\" ng-model=\"name\" class=\"form-control\"></div></div></div></form></div>");
  ...
  $templateCache.put("components/manage/product_types/views/edit.html", "<page-header text=\"{{ type.name }}\"><btn type=\"primary\" icon=\"floppy-o\" ng-click=\"save()\">Save</btn></page-header><div class=\"page-content\"><form ng-submit=\"save()\"><div class=\"fake-table data-table\"><div class=\"tr\"><div class=\"td row-property center\">Name</div><div class=\"td row-value\"><input type=\"text\" id=\"name\" ng-model=\"type.name\" class=\"form-control\"></div></div></div></form></div>");
  ...
  $templateCache.put("components/manage/product_types/views/new.html", "<page-header text=\"New Product Type\"><btn type=\"primary\" icon=\"floppy-o\" ng-click=\"save()\">Save</btn></page-header><div class=\"page-content\"><form ng-submit=\"save()\"><div class=\"fake-table data-table\"><div class=\"tr\"><div class=\"td row-property center\">Name</div><div class=\"td row-value\"><input type=\"text\" id=\"name\" ng-model=\"name\" class=\"form-control\"></div></div></div></form></div>");
