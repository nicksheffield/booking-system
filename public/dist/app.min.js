...
angular.module("app.views").run(["$templateCache", function ($templateCache) {
  ...
  $templateCache.put("components/manage/units/views/export.html", "<page-header text=\"Export Units\"></page-header><div class=\"page-content\"><textarea ng-model=\"csv\" readonly cols=\"30\" rows=\"20\" class=\"form-control\"></textarea></div>");
  ...
  $templateCache.put("components/manage/users/views/export.html", "<page-header text=\"Export Users\"></page-header><div class=\"page-content\"><textarea ng-model=\"csv\" readonly cols=\"30\" rows=\"20\" class=\"form-control\"></textarea></div>");
