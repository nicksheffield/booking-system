...
angular.module('app.controllers').controller('unitManageCtrl', ["$scope", "$store", function ($scope, $store) {
	...
	$scope.product_id = function (u) {
		return u.product ? u.product.id : 0;
	};
	$scope.unit_number = function (u) {
