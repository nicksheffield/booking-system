	...
	$scope.booking.$promise.then($prepare.booking).then(function (booking) {
		...
		$scope.dataTable = {
			...
			cols: [{
				...
				name: 'Unit',
				prop: function prop(x) {
					return x.limitless ? 'N/A' : $store.get('units', x.pivot.unit_id).unit_number;
				}
			}, {
				name: 'Notes',
				prop: function prop(x) {
